...
void runExperiment(G& x, istream& fstream, size_t rows, size_t size, double batchFraction) {
  ...
  for (int batchIndex=0; batchIndex<BATCH_LENGTH; ++batchIndex) {
    ...
    auto c2 = leidenNaiveDynamicOmp(y, deletions, insertions, CM2, CV2, CC2, {repeat});
    ...
    auto c3 = leidenDynamicDeltaScreeningOmp(y, deletions, insertions, CM3, CV3, CC3, {repeat});
    ...
    auto c4 = leidenDynamicFrontierOmp(y, deletions, insertions, CM4, CV4, CC4, {repeat});
